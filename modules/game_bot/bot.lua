...
local configManagerUrl = "http://yourwebsite/configs.php"
...
function init()
  ...
  botButton = modules.client_topmenu.addRightGameToggleButton('botButton', tr('Bot'), '/images/topbuttons/bot', toggle, false, 7)
